...
- `packages/tui/extensions/Worklog/chatPane.ts` — Chat pane for natural language work item management
- `packages/tui/extensions/Worklog/actionPalette.ts` — Keyboard-first action palette
