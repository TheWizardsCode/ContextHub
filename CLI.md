...
For the standalone Pi Worklog browse extension (`/wl`, `Ctrl+Shift+B`), link this repository's extension directory into the target project's `.pi/extensions` path:
