...
let _globalRuntime: WorklogRuntime | null = null;
 ...
 */
export function getRuntime(): WorklogRuntime {
  if (!_globalRuntime) {
 ...
 */
export function initializeRuntime(options: RuntimeOptions = {}): WorklogRuntime {
