 ...
 */
export function getGlobalPluginDir() {
 ...
 */
export function resolvePluginDir(options) {
 ...
 */
export function discoverAllPlugins(dirs) {
    const seen = new Map();
 ...
 */
export async function loadPlugin(pluginPath, ctx, verbose = false, source) {
 ...
 */
export async function loadPlugins(ctx, options) {
 ...
 */
export function hasCommand(program, commandName) {
