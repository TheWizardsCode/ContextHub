...
export const DEFAULT_SHORTCUTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: 'Alt+T', description: 'Show intake_complete (non-closed) items' },
      { keys: 'Alt+P', description: 'Show plan_complete (non-closed) items' },
...
export const KEY_FILTER_IN_PROGRESS = ['M-i'];
export const KEY_FILTER_OPEN = ['M-a'];
  export const KEY_RUN_AUDIT = ['A'];
export const KEY_FILTER_BLOCKED = ['M-b'];
export const KEY_FILTER_NEEDS_REVIEW = ['M-v'];
export const KEY_FILTER_INTAKE_COMPLETED = ['M-t'];
export const KEY_FILTER_PLAN_COMPLETED = ['M-p'];
