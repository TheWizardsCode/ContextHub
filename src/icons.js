 ...
 * `noIcons` option.
 */
export function iconsEnabled(opts) {
    ...
    if (opts?.noIcons === false)
        return true;
    // Global env var opt-out.
    if (typeof process !== 'undefined' && process.env?.WL_NO_ICONS === '1')
        return false;
 ...
 */
export function priorityIcon(priority, opts) {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function statusIcon(status, opts) {
 ...
 */
export function priorityFallback(priority) {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function riskIcon(risk, opts) {
 ...
 */
export function riskFallback(risk) {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function effortIcon(effort, opts) {
 ...
 */
export function effortFallback(effort) {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function stageIcon(stage, opts) {
 ...
 */
export function stageFallback(stage) {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function auditIcon(result, opts) {
 ...
 */
export function auditLabel(result) {
 ...
 */
export function auditFallback(result) {
    return AUDIT_FALLBACK[auditKey(result)] ?? '';
}
// ─── Stale Audit Result Icons ───────────────────────────────────────────
const STALE_AUDIT_ICON = {
    yes: '\u{1F7E9}', // 🟩 Green square button
};
const STALE_AUDIT_FALLBACK = {
    yes: '[YES_STALE]',
};
const STALE_AUDIT_LABEL = {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function auditStaleIcon(result, opts) {
    if (result === true) {
        if (opts?.noIcons === true) {
 ...
 */
export function auditStaleLabel(result) {
    if (result === true) {
 ...
 */
export function auditStaleFallback(result) {
    if (result === true) {
        return STALE_AUDIT_FALLBACK.yes;
    }
 ...
 */
function producerReviewKey(needsProducerReview) {
    if (needsProducerReview === true)
        return 'needed';
    return 'not_needed';
}
const PRODUCER_REVIEW_ICON = {
    needed: '\u{274C}', // ❌
    not_needed: '\u{2705}', // ✅
};
const PRODUCER_REVIEW_FALLBACK = {
    needed: '[NEEDS_PRODUCER]',
    not_needed: '[PRODUCER_OK]',
};
const PRODUCER_REVIEW_LABEL = {
 ...
 * @returns The icon string (emoji or bracketed text).
 */
export function needsProducerReviewIcon(needsProducerReview, opts) {
 ...
 */
export function needsProducerReviewLabel(needsProducerReview) {
 ...
 */
export function needsProducerReviewFallback(needsProducerReview) {
