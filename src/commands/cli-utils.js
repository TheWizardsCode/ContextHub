 ...
 */
export function normalizeActionArgs(rawArgs, knownOptionKeys) {
    ...
    while (args.length > 0) {
        ...
        if (typeof last.opts === 'function') {
            try {
                optsCandidate = last.opts();
            }
            catch {
                optsCandidate = last;
            }
 ...
 */
export function optionWasProvided(normalized, key) {
